...
import com.github.fangjinuo.sqlhelper.dialect.orderby.StringOrderByBuilder;
import org.junit.Test;

public class StringOrderByBuilderTests {
    @Test
    public void test() {
        StringOrderByBuilder builder = new StringOrderByBuilder();
