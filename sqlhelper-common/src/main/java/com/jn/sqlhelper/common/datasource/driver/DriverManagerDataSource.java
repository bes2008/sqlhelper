package com.jn.agileway.jdbc.datasource.driver;


import com.jn.agileway.jdbc.datasource.AbstractDriverBasedDataSource;
...
public class DriverManagerDataSource extends AbstractDriverBasedDataSource {
    ...
    public void setDriverClassName(String driverClassName) {
        Preconditions.checkNotEmpty(driverClassName, "Property 'driverClassName' must not be empty");
        String driverClassNameToUse = driverClassName.trim();
        try {
            Class.forName(driverClassNameToUse, true, ClassLoaders.getDefaultClassLoader());
        }
