...
import com.jn.agileway.jdbc.datasource.driver.DriverManagerDataSource;
import com.jn.agileway.jdbc.datasource.driver.SimpleDriverDataSource;
...
public abstract class AbstractDriverBasedDataSource extends AbstractDataSource {
    ...
    public void setUrl(String url) {
        Preconditions.checkNotEmpty(url, "Property 'url' must not be empty");
        this.url = url.trim();
    }
