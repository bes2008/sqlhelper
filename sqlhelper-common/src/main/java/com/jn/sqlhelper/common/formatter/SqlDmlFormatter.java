 ...
 */
public class SqlDmlFormatter implements Formatter<String, String> {
    ...
    private static final String INITIAL = LineDelimiter.DEFAULT.getValue() + INDENT_STRING;
    ...
    private static class FormatProcess {
        ...
        private static boolean isWhitespace(String token) {
            return SQLs.WHITESPACE.contains(token);
        }

        private void newline() {
            result.append(LineDelimiter.DEFAULT.getValue());
