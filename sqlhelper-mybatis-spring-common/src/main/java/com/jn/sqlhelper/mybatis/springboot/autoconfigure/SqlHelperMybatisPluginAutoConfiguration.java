...
public class SqlHelperMybatisPluginAutoConfiguration {
    ...
    public SqlHelperMybatisPlugin sqlHelperMybatisPlugin(SqlHelperMybatisProperties sqlHelperMybatisProperties){
        ...
        plugin.init();
        logger.info("===[SQLHelper & tk.mapper]=== The properties of the mybatis plugin [{}] is: {}", Reflects.getFQNClassName(SqlHelperMybatisPlugin.class), sqlHelperMybatisProperties);
        return plugin;
    }
